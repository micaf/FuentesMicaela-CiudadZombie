...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 80, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 800, 450, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 500, 430, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 800, 200, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 230, 400, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 800, 200, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 170, 250, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 290, 220, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 500, 100, 30, 15, 2),
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',100,400,10,10,1,{desdeX: 100, hastaX: 200, desdeY: 300, hastaY: 500}),
    new ZombieCaminante('imagenes/zombie2.png',300,450,10,10,1,{desdeX: 300, hastaX: 500, desdeY: 450, hastaY: 500}),
    new ZombieCaminante('imagenes/zombie3.png',300,80,10,10,1,{desdeX: 300, hastaX: 400, desdeY: 80, hastaY: 100}),
    new ZombieCaminante('imagenes/zombie4.png',750,80,10,10,1,{desdeX: 750, hastaX: 850, desdeY: 80, hastaY: 100}),
    new ZombieCaminante('imagenes/zombie1.png',750,400,10,10,1,{desdeX: 750, hastaX: 850, desdeY: 400, hastaY: 500}),
    new ZombieConductor('imagenes/tren_horizontal.png',400,322,90,30,3,{desdeX: 80, hastaX: 900},'h'),
    new ZombieConductor('imagenes/tren_vertical.png',644,0,30,90,3,{desdeY: 0, hastaY: 500},'v'),
    new ZombieConductor('imagenes/tren_vertical.png',678,0,30,90,3,{desdeY: 0, hastaY: 500},'v'),
  ],
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    /* COMPLETAR */
    Jugador.mover(tecla,movX + this.jugador.x, movY + this.jugador.y);
  }
};
...
Juego.dibujar = function() {
  ...
  //Este método demarcar en el mapa la llegada
  Dibujante.dibujarRectangulo('white', 750, 530, 150, 8);
